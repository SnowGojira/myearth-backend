    ...
    <div class="tab-wrap">
        ...
        <div class="tab-content">
            <div class="form-item">
                ...
                <div class="controls">
                    <input type="text" class="text input-large" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>" disabled="disabled">
                </div>
            </div>
            <div class="form-item">
                <label class="item-label">
                ...
                <div class="controls">
                    <input type="text" class="text input-large" value="<?php echo ((isset($info["tel"]) && ($info["tel"] !== ""))?($info["tel"]):''); ?>" disabled="disabled">
                </div>
            </div>
            <div class="form-item">
                <label class="item-label">
                ...
                <div class="controls">
                    <input type="text" class="text input-large" value="<?php echo ((isset($info["mail"]) && ($info["mail"] !== ""))?($info["mail"]):''); ?>" disabled="disabled">
                </div>
            </div>
            <div class="form-item">
                <label class="item-label">
                ...
                <div class="controls">
                    <textarea style="height: 130px;" class="textarea input-large" disabled="disabled"><?php echo ((isset($info["info"]) && ($info["info"] !== ""))?($info["info"]):''); ?></textarea>
                </div>
            </div>
            <div class="form-item">
                <label class="item-label">
                ...
                <div class="controls">
                    <input type="text" class="text input-large" value="<?php echo (time_format($info["name"])); ?>"  disabled="disabled">
                </div>
            </div>
