...
<div class="wrap">
    ...
    <section class="main clearfix">
        <article class="m-special">
            <hgroup class="m-title m-title2">
                <h1 class="m-t-zh"><?php echo ($category['title']); ?></h1>
                <h2 class="m-t-en"><?php echo ($category['name']); ?></h2>
            </hgroup>
            <ul class="m-cont clearfix">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="m-c-row">
                        <a class="m-c-r-img" href="<?php echo U('Article/detail', 'id='.$vo['id']);?>"><img class="m-c-r-img" src="<?php echo ($vo['cover_path']); ?>" alt=""></a>
                        <div class="m-c-r-wrap">
                            <h5 class="m-c-r-tit"><?php echo ($vo['title']); ?></h5>
                            <p class="m-c-r-info"><?php echo ($vo['subtitle']); ?></p>
                        </div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
                <!--<li class="m-c-row">-->
                <!--<a class="m-c-r-img" href="../Static/project-e1.html"><img class="m-c-r-img" src="/Public/images/project/e1.jpg" alt=""></a>-->
                <!--<div class="m-c-r-wrap">-->
                ...
                <!--</li>-->
                <!--<li class="m-c-row">-->
                    <!--<a class="m-c-r-img" href="../Static/project-sdetailed1.html"><img class="m-c-r-img" src="/Public/images/project/special1.jpg" alt=""></a>-->
                    <!--<div class="m-c-r-wrap">-->
                        <!--<h5 class="m-c-r-tit">Go Campus美国奖学金计划</h5>-->
                        <!--<p class="m-c-r-info">圆你超级美国梦，开启留学新时代</p>-->
                    <!--</div>-->
                <!--</li>-->
                <!--<li class="m-c-row">-->
            ...
            <?php echo ($_page); ?>
            <!--<div class="m-page">-->
                <!--&lt;!&ndash; class[m-p-disable:禁用] [m-p-select:当前页面] 每一页4*3 12项&ndash;&gt;-->
                <!--<a class="m-p-prev m-p-disable" href="">上一页</a>-->
                <!--<a class="m-p-num m-p-select" href="">1</a>-->
                <!--&lt;!&ndash;<a class="m-p-num" href="">2</a>&ndash;&gt;-->
                <!--&lt;!&ndash;<a class="m-p-num" href="">3</a>&ndash;&gt;-->
                <!--<a class="m-p-next m-p-disable" href="">下一页</a>-->
            <!--</div>-->
        </article>
    </section>
    <!--include footer.html-->
