...
<div class="wrap">
    ...
    <section class="main2">
        <article class="m2-info">
            <img class="m2-i-pic" src="/Public/images/community/detail1-3.jpg" alt="">
            <div class="m2-i-wrap">
                <h3 class="m2-i-name">Heidi / 迈尔斯国际专家级顾问</h3>
                <p class="m2-i-intro">经验丰富值：
                    7年英国咨询经验；
                    <br>专业优势：
                    曾在英国官方教育中心和大型国际教育集团担任业务负责人。熟悉英澳及香港留学体系，先后多次赴英国考察；

                </p>
                <p class="m2-i-recom">成功案例：
                    曾经多次帮学生申请到世界著名大学如：帝国理工、伦敦政治经济学院、香港大学等。
                </p>
            </div>
        </article>
